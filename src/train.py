...
def main():
    ...
    parser.add_argument("--X-train", type=str, required=False,
                        default="data/splits/X_train.npy",
                        help="Path to training features")
    parser.add_argument("--y-train", type=str, required=False,
                        default="data/splits/y_train.npy",
                        help="Path to training labels")
    parser.add_argument("--X-test", type=str, required=False,
                        default="data/splits/X_test.npy",
                        help="Path to test features")
    parser.add_argument("--y-test", type=str, required=False,
                        default="data/splits/y_test.npy",
                        help="Path to test labels")
    parser.add_argument("--sample-weight", type=str, required=False, default=None,
                        help="Path to sample weights")
    parser.add_argument("--base-model-version", type=str, required=False,
                        default=None,
    ...
    parser.add_argument("--model-filename", type=str, required=False,
                        default="sentiment_classifier.joblib",
                        help="Model filename")
